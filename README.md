...
截止到2026年7月19日17:12，我这边网站还没开始部署因为我还在写这篇README.md。
网站的html可以下载，不过**不能作为商用**，作为参考还是可以的。
感谢阅读。
...
This project is my 1st project(although it had its fourth searchable ver. Early in May 24, 2026). If you think some code is NOT good you can tell me in my E-mail.
You can download this html code for reference. But **PLEASE DONT SELL IT BY YOURSELF**. *MEOW!*
Thanks for read it.
Yours, 
Suguang(a writer)
